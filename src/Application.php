 ...
 * @property string $tencentnew 腾讯OCR识别新版本API
 *     method array idcard($image, $options = []) 身份证识别
 *     method array bizlicense($image, $options = []) 营业执照识别
 */
class Application extends Container
{
    ...
    protected $providers = [
        ...
        Providers\TencentNewProvider::class
    ];
     ...
     * @return mixed
     */
    public function tencentnew() {
        return $this['tencentnew'];
    }
}
